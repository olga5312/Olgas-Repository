...
public class AllTests2 {
	...
	class TestFile1 {
		...
		public final void testfile1_Route_A_E_Distance() {
			...
			route.add("C\\s*->\\s*D");
			route.add("D\\s*->\\s*E");
			// olgas Sysout to see the route with my algorithm
			System.out.println("ExpectedShortest1" + route);
			System.out.println("ActuallyShortest1" + nav.findShortestRoute("A", "E"));
		...
		public final void testfile1_Route_A_F_Time() {
			...
			route.add("D\\s*->\\s*F");
			// olgas Sysout to see the route with my algorithm
			System.out.println("ExpectedFastest1" + route);
			System.out.println("ActuallyFastest1" + nav.findFastestRoute("A", "F"));
	...
	class TestFile2 {
		...
		public final void testfile2_Route_A_E_Distance() {
			...
			route.add("D\\s*->\\s*E");
			// olgas Sysout to see the route with my algorithm
			System.out.println("ExpectedShortest2" + route);
			System.out.println("ActuallyShortest2" + nav.findShortestRoute("A", "E"));
			assertTrue(testRoute(nav.findShortestRoute("A", "E"), route), "Route not correct");
		}
		...
		public final void testfile2_Route_A_E_Time() {
			...
			route.add("C\\s*->\\s*E");
			// olgas Sysout to see the route with my algorithm
			System.out.println("ExpectedFastest2" + route);
			System.out.println("ActuallyFastest2" + nav.findFastestRoute("A", "E"));
